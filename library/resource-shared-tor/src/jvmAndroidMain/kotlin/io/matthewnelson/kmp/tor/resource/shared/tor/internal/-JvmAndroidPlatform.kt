 ...
 **/
package io.matthewnelson.kmp.tor.resource.shared.tor.internal

import io.matthewnelson.kmp.tor.common.api.InternalKmpTorApi
import io.matthewnelson.kmp.tor.common.core.OSHost
import io.matthewnelson.kmp.tor.common.core.OSInfo
import io.matthewnelson.kmp.tor.common.core.Resource
import io.matthewnelson.kmp.tor.resource.shared.tor.ALIAS_TOR
...
internal inline fun Resource.Config.Builder.configureTorResource(loader: Class<*>) {
    ...
    resource(ALIAS_TOR) {
        ...
        platform {
            ...
            resourcePath = "io/matthewnelson/kmp/tor/resource/shared/tor/native/$host/$arch/${host.torFileName}"
        }
    }
}
